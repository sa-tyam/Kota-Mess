...
public class GetMessHistoryList {
    ...
    static ArrayList<OrderItem> messOrderItemArrayList = new ArrayList<>();
    ...
    public static void getDataFromDatabase (DataStatus dataStatus) {
        ...
        messOrderItemArrayList.clear();

        // order ids array list
        ArrayList<String> orderIdArrayList = new ArrayList<>();

        // fetch data from firebase
        databaseReference.child("Mess").child(user.getUid()).child("History")
                            ...
                            databaseReference.child("Orders").child(orderIdArrayList.get(i))
                                    .addListenerForSingleValueEvent(new ValueEventListener() {
                                        ...
                                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                                            ...
                                            security_code = String.valueOf(snapshot.child("Security Code").getValue(String.class));
                                            ...
                                            messOrderItemArrayList.add(orderItem);

                                            // notify data is loaded
                                            dataStatus.DataIsLoaded(messOrderItemArrayList);
                                        }
